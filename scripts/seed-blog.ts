// One-off migration: copies the hand-written posts that used to live in
// the static src/data/blog.ts array into the new blog_post table. Run
// once via `npx tsx scripts/seed-blog.ts`, then delete this file — it has
// no ongoing purpose once seeded.
import { db } from "../src/db";
import { blogPosts, type BlogSection } from "../src/db/schema";
