...
export async function generateMetadata({
  ...
  //
  // Every file here is generated by scripts/build-icons.mjs from one master,
  // and the whole set was renamed when the artwork changed: a home-screen
  // icon is cached hard, and a device that already has the old one keeps
