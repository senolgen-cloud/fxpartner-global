...
export const brokers: Broker[] = [
  ...
  },
  {
    ...
    //
    // Careful with the two "lite-banner-fxpartner77*" files: 775 is this
    // wide creative and 77 is the tall rail one below. One character apart,
    // and neither name says which way round it is.
    ogImage: "/reklam/lite-banner-fxpartner775.png",
    ...
    promotions: [
      ...
      },
      {
        ...
        steps: [
          "FXPARTNER bağlantısı üzerinden Lite Finance Klasik (Classic) hesabı aç — kampanya yalnızca Klasik hesaplarda geçerli.",
