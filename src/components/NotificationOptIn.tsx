...
export default function NotificationOptIn() {
  ...
  return (
    <div
      ...
      className="fixed bottom-4 right-4 z-40 w-[calc(100%-2rem)] max-w-xs rounded-2xl border border-hairline bg-ink text-text-on-ink shadow-2xl motion-safe:animate-[popIn_0.25s_ease-out] sm:bottom-6 sm:right-6"
    >
      <div className="p-5">
